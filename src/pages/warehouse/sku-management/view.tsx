...
export function ViewSKUPage() {
  ...
  if (!entity) {
    return (
      <div className="container mx-auto py-6 px-4">
        <div>SkuManagement not found</div>
      </div>
    )
  }
  ...
  return (
    <div className="container mx-auto py-6 px-4 space-y-6">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <Button
            variant="outline"
            size="sm"
            onClick={() => navigate(`/src/pages/warehouse/sku-management/${id}/edit`)}
          >
      ...
      <Card>
        <CardHeader>
          <CardTitle>SkuManagement Details</CardTitle>
        </CardHeader>
